...
{
    /**
     * Método para obtener el vértice que tiene más sucesores 
     * @param g - grafo a evaluar
     * @return el vértice que tiene más vecinos
     */
    public static int vertice(Graph g)
    {
        int cont =0; //contador de los sucesores
        int max =0; //variable para almacenar el máximo
        int vertice=0; //variable para almacenar el vertice
