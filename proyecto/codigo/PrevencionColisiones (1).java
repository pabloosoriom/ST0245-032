...
public class PrevencionColisiones
{
    ...
    public static LinkedList<Point3D> leerArchivo(int numeroDeAbejas){
        ...
        Point3D abejaMaxT=new Point3D(-90,-180,0); 
        Point3D abejaMinT=new Point3D(90,180,8000);
        try {            
            ...
            while (lineaActual != null){ // Mientras no llegue al fin del archivo
                ...
                if(abeja.getX()>abejaMaxT.getX()&&abeja.getY()>abejaMaxT.getY()&&abeja.getY()>abejaMaxT.getY()){
                    abejaMaxT=abeja;
                }else if(abeja.getX()<abejaMinT.getX()&&abeja.getY()<abejaMinT.getY()&&abeja.getY()<abejaMinT.getY()){
                    abejaMinT=abeja;
                }
