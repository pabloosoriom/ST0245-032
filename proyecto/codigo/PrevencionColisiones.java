 ...
 * Complejidad: Peor Caso O(n al cuadrado) 
 *
...
public class PrevencionColisiones
{
     ...
     */
    public static ListaPeligro detectarColisiones(Point3D[] arregloDeAbejas){
        ListaPeligro abejasConRiesgoDeColision = new ListaPeligro();
        for (int i = 0; i < arregloDeAbejas.length ; ++i)
            for(int j = i+1; j < arregloDeAbejas.length; ++j)
                if (distancia(arregloDeAbejas[i], arregloDeAbejas[j]) <= 100){
                    abejasConRiesgoDeColision.añadirInicio(arregloDeAbejas[i]);
                    abejasConRiesgoDeColision.añadirInicio(arregloDeAbejas[j]);
     ...
     */
    public static void guardarArchivo(ListaPeligro abejasConRiesgoDeColision, int numeroDeAbejas){
        ...
        try {
            ...
            for (int i=0;i<tamaño;i++){
                Point3D abeja=ListaPeligro.get(0);
    ...
    public static void main (String [] args){
        ...
        ListaPeligro abejasConRiesgoDeColision = detectarColisiones(arregloDeAbejas);
